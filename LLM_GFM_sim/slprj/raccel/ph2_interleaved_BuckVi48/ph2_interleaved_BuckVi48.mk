###########################################################################
## Makefile generated for component 'ph2_interleaved_BuckVi48'. 
## 
## Makefile     : ph2_interleaved_BuckVi48.mk
## Generated on : Sat Apr 25 19:28:52 2026
## Final product: ./ph2_interleaved_BuckVi48.exe
...
PRODUCT_NAME              = ph2_interleaved_BuckVi48
MAKEFILE                  = ph2_interleaved_BuckVi48.mk
MATLAB_ROOT               = D:/MATLAB/R2024a
MATLAB_BIN                = D:/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/XingTong/Desktop/VSG_Adaptive_Control/LLM_GFM_sim
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = ph2_interleaved_BuckVi48_comp.rsp
CMD_FILE                  = ph2_interleaved_BuckVi48.rsp
...
PRODUCT = ./ph2_interleaved_BuckVi48.exe
...
DEFINES_STANDARD = -DMODEL=ph2_interleaved_BuckVi48 -DNUMST=3 -DNCSTATES=4 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/ph2_interleaved_BuckVi48.c $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/ph2_interleaved_BuckVi48_capi.c $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/ph2_interleaved_BuckVi48_data.c $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/ph2_interleaved_BuckVi48_tgtconn.c $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/rtGetInf.c $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = ph2_interleaved_BuckVi48.obj ph2_interleaved_BuckVi48_capi.obj ph2_interleaved_BuckVi48_data.obj ph2_interleaved_BuckVi48_tgtconn.obj rtGetInf.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ph2_interleaved_BuckVi48.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/ph2_interleaved_BuckVi48.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ph2_interleaved_BuckVi48_capi.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/ph2_interleaved_BuckVi48_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ph2_interleaved_BuckVi48_data.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/ph2_interleaved_BuckVi48_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ph2_interleaved_BuckVi48_tgtconn.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/ph2_interleaved_BuckVi48_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/ph2_interleaved_BuckVi48/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
